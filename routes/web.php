...
Route::get('/controle/logout', 'PagesController@logout')
->name('usuario.logout');
...
Route::get('/controle/debitos', 'PagesController@debitos')->name('debitos');
...
Route::post('/controle/presencas/new','PresencasController@store')->name('presenca.store');
